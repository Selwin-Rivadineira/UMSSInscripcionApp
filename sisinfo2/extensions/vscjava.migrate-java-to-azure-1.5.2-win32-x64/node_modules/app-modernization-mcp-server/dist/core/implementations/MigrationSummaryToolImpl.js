...
async function sendTelemetryForMigration(context, workspacePath, kbs, status, versionControlSummary) {
    ...
    eventEmitter.emit('consistency_check_result', {
        ...
        workspacePath,
        critical: ((_k = (_j = status === null || status === void 0 ? void 0 : status.consistencyCheckStatus) === null || _j === void 0 ? void 0 : _j.result) === null || _k === void 0 ? void 0 : _k.critical) || 0,
        major: ((_m = (_l = status === null || status === void 0 ? void 0 : status.consistencyCheckStatus) === null || _l === void 0 ? void 0 : _l.result) === null || _m === void 0 ? void 0 : _m.major) || 0,
        minor: ((_p = (_o = status === null || status === void 0 ? void 0 : status.consistencyCheckStatus) === null || _o === void 0 ? void 0 : _o.result) === null || _p === void 0 ? void 0 : _p.minor) || 0,
    }, context);
    eventEmitter.emit('completeness_check_result', {
        result: ((_q = status === null || status === void 0 ? void 0 : status.completenessCheckStatus) === null || _q === void 0 ? void 0 : _q.status) || 'unknown',
        message: ((_r = status === null || status === void 0 ? void 0 : status.completenessCheckStatus) === null || _r === void 0 ? void 0 : _r.error) || '',
        workspacePath,
    }, context);
    for (const kb of kbs) {
